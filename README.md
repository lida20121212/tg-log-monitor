...
默认排除 `"response": {"code":40102`、`"response": {"code":40205`、`"error": "Verification failed", "response": {"code":1,"msg":"Verification failed"`、`This device is already registered...mobile phone number ending in...` 以及 `paymentchannel/` 这类已知业务错误，不发送到 TG 群。
